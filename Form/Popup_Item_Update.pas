...
type
  TfrmPopup_Item_Update = class(TForm)
    Pnl_Main: TPanel;
    Pnl_Sub: TPanel;
    Pnl_Top: TPanel;
    Pnl_BTN: TPanel;
...
var
  frmPopup_Item_Update: TfrmPopup_Item_Update;
...
// btnSaveClick
//==============================================================================
procedure TfrmPopup_Item_Update.btnSaveClick(Sender: TObject);
var
...
// FormActivate
//==============================================================================
procedure TfrmPopup_Item_Update.FormActivate(Sender: TObject);
begin
  SetItemList;
end;
...
// FormDeactivate
//==============================================================================
procedure TfrmPopup_Item_Update.FormDeactivate(Sender: TObject);
var
  i : integer ;
begin
...
// FormClose
//==============================================================================
procedure TfrmPopup_Item_Update.FormClose(Sender: TObject; var Action: TCloseAction);
var
  i : integer ;
begin
  for i := 0 to Self.ComponentCount-1 do
...
// SetItemList
//==============================================================================
procedure TfrmPopup_Item_Update.SetItemList;
var
  StrSQL : String;
begin
  try
...
// btnCloseClick
//==============================================================================
procedure TfrmPopup_Item_Update.btnCloseClick(Sender: TObject);
begin
  Close;
end;
